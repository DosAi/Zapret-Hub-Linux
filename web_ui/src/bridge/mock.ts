...
const components: Record<ComponentId, import("./types").ComponentInfo> = {
  zapret: {
    ...
    version: "0.71.1",
    status: "on",
    description: "Локальная обработка трафика через nfqws",
    config: "Стратегия: general-alt · Порты: 80,443",
  ...
  zapret2: {
    ...
    externalUrl: "https://github.com/bol-van/zapret2",
  },
  "goshkow-vpn": {
    id: "goshkow-vpn",
    name: "Happ",
    version: "3.3.6",
    status: "off",
    description: "Независимый VPN-клиент для Linux",
    config: "Подписка настраивается в приложении Happ",
    externalUrl: "https://github.com/Happ-proxy/happ-desktop",
  },
  "tg-ws-proxy": {
    id: "tg-ws-proxy",
    name: "TG WS Proxy",
...
const initialState: AppState = {
  ...
  onboarding: { completed: true, isUpdate: false, forceOpen: false },
  ui: { locale: "ru", theme: "night", hasValidVpnKey: false, platform: "linux" },
};
