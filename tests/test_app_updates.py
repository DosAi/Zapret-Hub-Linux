...
MIRROR_FIXTURE = {
    ...
    "assets": {
        "installer": {
            ...
            "download_url": "https://downloads.example.com/zapret-hub/installer",
            "digest": "sha256:aaa",
            "size": 10,
        },
        "x64": {
            "name": "zapret_hub_2.1.2_portable_win_x64.zip",
            "download_url": "https://downloads.example.com/zapret-hub/x64",
            "digest": "sha256:bbb",
            "size": 20,
        ...
        "arm64": {
            ...
            "download_url": "https://downloads.example.com/zapret-hub/arm64",
            "digest": "sha256:ccc",
            "size": 21,
        },
    },
...
def test_normalize_mirror_payload_maps_download_urls() -> None:
    ...
    assert by_arch["x64"]["browser_download_url"] == "https://downloads.example.com/zapret-hub/x64"
    assert by_arch["arm64"]["browser_download_url"] == "https://downloads.example.com/zapret-hub/arm64"
...
def test_pick_release_asset_prefers_architecture_key(monkeypatch) -> None:
    ...
    assert picked["browser_download_url"] == "https://downloads.example.com/zapret-hub/x64"
...
def test_version_compare_available_and_uptodate(monkeypatch) -> None:
    ...
    assert status["asset_url"] == "https://downloads.example.com/zapret-hub/x64"
